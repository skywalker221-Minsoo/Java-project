...
public class Chap9_2_Practice {
	...
	enum Menu {
		...
		private final String message;	//출력한 문자열
	...
	public static void main(String[] args) {
		...
		Chap9_2<Data> list = new Chap9_2<Data>();	//리스트를 생성
		...
		do {
			...
			case RMV_FIRST:			//머리에 노드를 삭제
				list.removeFirst();
				break;
				
			case RMV_LAST:			//꼬리에 노드를 삭제
				list.removeLast();
				break;
